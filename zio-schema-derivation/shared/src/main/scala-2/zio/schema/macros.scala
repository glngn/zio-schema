  ...
  def genImpl[T: c.WeakTypeTag](c: whitebox.Context): c.Tree = {
        ...
        if (arity > 22) {
          val fields = fieldTypes.zip(fieldAnnotations).map {
            case (termSymbol, annotations) =>
              ...
              q"_root_.zio.schema.Schema.Field.apply($fieldLabel,$fieldSchema,zio.Chunk.apply[Any](..$annotations))"
          }
          val fromMap = {
          ...
          val fieldDefs = fieldTypes.zip(fieldAnnotations).zipWithIndex.map {
            case ((termSymbol, annotations), idx) =>
              ...
              if (annotations.nonEmpty)
                q"""$fieldArg = _root_.zio.schema.Schema.Field.apply(label = $fieldLabel, schema = $fieldSchema, annotations = _root_.zio.Chunk.apply[Any](..$annotations))"""
              else
                q"""$fieldArg = _root_.zio.schema.Schema.Field.apply(label = $fieldLabel, schema = $fieldSchema)"""
          }
          ...
          fieldTypes.size match {
            case 1 => out(tq"_root_.zio.schema.Schema.CaseClass1[..$typeArgs]")
            case 2 => out(tq"_root_.zio.schema.Schema.CaseClass2[..$typeArgs]")
            case 3 => out(tq"_root_.zio.schema.Schema.CaseClass3[..$typeArgs]")
            case 4 => out(tq"_root_.zio.schema.Schema.CaseClass4[..$typeArgs]")
            case 5 => out(tq"_root_.zio.schema.Schema.CaseClass5[..$typeArgs]")
            case 6 => out(tq"_root_.zio.schema.Schema.CaseClass6[..$typeArgs]")
            case 7 => out(tq"_root_.zio.schema.Schema.CaseClass7[..$typeArgs]")
            case 8 => out(tq"_root_.zio.schema.Schema.CaseClass8[..$typeArgs]")
            case 9 => out(tq"_root_.zio.schema.Schema.CaseClass9[..$typeArgs]")
            case 10 => out(tq"_root_.zio.schema.Schema.CaseClass10[..$typeArgs]")
            case 11 => out(tq"_root_.zio.schema.Schema.CaseClass11[..$typeArgs]")
            case 12 => out(tq"_root_.zio.schema.Schema.CaseClass12[..$typeArgs]")
            case 13 => out(tq"_root_.zio.schema.Schema.CaseClass13[..$typeArgs]")
            case 14 => out(tq"_root_.zio.schema.Schema.CaseClass14[..$typeArgs]")
            case 15 => out(tq"_root_.zio.schema.Schema.CaseClass15[..$typeArgs]")
            case 16 => out(tq"_root_.zio.schema.Schema.CaseClass16[..$typeArgs]")
            case 17 => out(tq"_root_.zio.schema.Schema.CaseClass17[..$typeArgs]")
            case 18 => out(tq"_root_.zio.schema.Schema.CaseClass18[..$typeArgs]")
            case 19 => out(tq"_root_.zio.schema.Schema.CaseClass19[..$typeArgs]")
            case 20 => out(tq"_root_.zio.schema.Schema.CaseClass20[..$typeArgs]")
            case 21 => out(tq"_root_.zio.schema.Schema.CaseClass21[..$typeArgs]")
            case 22 => out(tq"_root_.zio.schema.Schema.CaseClass22[..$typeArgs]")
            case s =>
              c.abort(
                tpe.termSymbol.pos,
    ...
    def deriveEnum(tpe: Type, stack: List[Frame[c.type]]): Tree = {
      ...
      val cases = subtypes.map { subtype: Type =>
        ...
        if (typeAnnotations.isEmpty)
          q"_root_.zio.schema.Schema.Case.apply[$subtype,$tpe]($caseLabel,$caseSchema,$deconstructFn)"
        else {
          val annotationArgs = q"zio.Chunk.apply(..$typeAnnotations)"
          q"_root_.zio.schema.Schema.Case.apply[$subtype,$tpe]($caseLabel,$caseSchema,$deconstructFn,$annotationArgs)"
        }
      }

      val applyArgs =
        if (typeAnnotations.isEmpty)
          cases ++ Iterable(q"annotations = _root_.zio.Chunk.empty")
        else
          cases ++ Iterable(q"annotations = _root_.zio.Chunk.apply(..$typeAnnotations)")

      def out(outType: Tree, outValue: Tree): Tree =
        q"""
         {
           def ${selfRefIdent.name.toTermName}: $outType = $outValue
           $selfRefIdent
         }
         """
      cases.size match {
        ...
        case 1 =>
          out(tq"_root_.zio.schema.Schema.Enum1[..$typeArgs]", q"_root_.zio.schema.Schema.Enum1[..$typeArgs](..$applyArgs)")
        case 2 =>
          out(tq"_root_.zio.schema.Schema.Enum2[..$typeArgs]", q"_root_.zio.schema.Schema.Enum2[..$typeArgs](..$applyArgs)")
        case 3 =>
          out(tq"_root_.zio.schema.Schema.Enum3[..$typeArgs]", q"_root_.zio.schema.Schema.Enum3[..$typeArgs](..$applyArgs)")
        case 4 =>
          out(tq"_root_.zio.schema.Schema.Enum4[..$typeArgs]", q"_root_.zio.schema.Schema.Enum4[..$typeArgs](..$applyArgs)")
        case 5 =>
          out(tq"_root_.zio.schema.Schema.Enum5[..$typeArgs]", q"_root_.zio.schema.Schema.Enum5[..$typeArgs](..$applyArgs)")
        case 6 =>
          out(tq"_root_.zio.schema.Schema.Enum6[..$typeArgs]", q"_root_.zio.schema.Schema.Enum6[..$typeArgs](..$applyArgs)")
        case 7 =>
          out(tq"_root_.zio.schema.Schema.Enum7[..$typeArgs]", q"_root_.zio.schema.Schema.Enum7[..$typeArgs](..$applyArgs)")
        case 8 =>
          out(tq"_root_.zio.schema.Schema.Enum8[..$typeArgs]", q"_root_.zio.schema.Schema.Enum8[..$typeArgs](..$applyArgs)")
        case 9 =>
          out(tq"_root_.zio.schema.Schema.Enum9[..$typeArgs]", q"_root_.zio.schema.Schema.Enum9[..$typeArgs](..$applyArgs)")
        case 10 =>
          out(tq"_root_.zio.schema.Schema.Enum10[..$typeArgs]", q"_root_.zio.schema.Schema.Enum10[..$typeArgs](..$applyArgs)")
        case 11 =>
          out(tq"_root_.zio.schema.Schema.Enum11[..$typeArgs]", q"_root_.zio.schema.Schema.Enum11[..$typeArgs](..$applyArgs)")
        case 12 =>
          out(tq"_root_.zio.schema.Schema.Enum12[..$typeArgs]", q"_root_.zio.schema.Schema.Enum12[..$typeArgs](..$applyArgs)")
        case 13 =>
          out(tq"_root_.zio.schema.Schema.Enum13[..$typeArgs]", q"_root_.zio.schema.Schema.Enum13[..$typeArgs](..$applyArgs)")
        case 14 =>
          out(tq"_root_.zio.schema.Schema.Enum14[..$typeArgs]", q"_root_.zio.schema.Schema.Enum14[..$typeArgs](..$applyArgs)")
        case 15 =>
          out(tq"_root_.zio.schema.Schema.Enum15[..$typeArgs]", q"_root_.zio.schema.Schema.Enum15[..$typeArgs](..$applyArgs)")
        case 16 =>
          out(tq"_root_.zio.schema.Schema.Enum16[..$typeArgs]", q"_root_.zio.schema.Schema.Enum16[..$typeArgs](..$applyArgs)")
        case 17 =>
          out(tq"_root_.zio.schema.Schema.Enum17[..$typeArgs]", q"_root_.zio.schema.Schema.Enum17[..$typeArgs](..$applyArgs)")
        case 18 =>
          out(tq"_root_.zio.schema.Schema.Enum18[..$typeArgs]", q"_root_.zio.schema.Schema.Enum18[..$typeArgs](..$applyArgs)")
        case 19 =>
          out(tq"_root_.zio.schema.Schema.Enum19[..$typeArgs]", q"_root_.zio.schema.Schema.Enum19[..$typeArgs](..$applyArgs)")
        case 20 =>
          out(tq"_root_.zio.schema.Schema.Enum20[..$typeArgs]", q"_root_.zio.schema.Schema.Enum20[..$typeArgs](..$applyArgs)")
        case 21 =>
          out(tq"_root_.zio.schema.Schema.Enum21[..$typeArgs]", q"_root_.zio.schema.Schema.Enum21[..$typeArgs](..$applyArgs)")
        case 22 =>
          out(tq"_root_.zio.schema.Schema.Enum22[..$typeArgs]", q"_root_.zio.schema.Schema.Enum22[..$typeArgs](..$applyArgs)")
        case _ =>
          val caseSet     = q"_root_.zio.schema.CaseSet.apply(..$cases).asInstanceOf[zio.schema.CaseSet.Aux[$tpe]]"
          val caseSetType = c.typecheck(caseSet, c.TYPEmode).tpe

          if (typeAnnotations.isEmpty)
            q"""{lazy val $selfRefIdent: _root_.zio.schema.Schema.EnumN[$tpe,$caseSetType] = _root_.zio.schema.Schema.EnumN.apply[$tpe,$caseSetType]($caseSet); $selfRefIdent}"""
          else {
            val annotationArg = q"_root_.zio.Chunk.apply(..$typeAnnotations)"

            q"""{lazy val $selfRefIdent: _root_.zio.schema.Schema.EnumN[$tpe,$caseSetType] = _root_.zio.schema.Schema.EnumN.apply[$tpe,$caseSetType]($caseSet,$annotationArg); $selfRefIdent}"""
          }
      }
    }
